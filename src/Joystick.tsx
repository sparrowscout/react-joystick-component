...
class Joystick extends React.Component<IJoystickProps, IJoystickState> {
  ...
  componentDidUpdate(prevProps: Readonly<IJoystickProps>): void {
    ...
    if (this.props.isPressure !== prevProps.isPressure) {
      console.log(this.props.isPressure, prevProps.isPressure);
      console.log(this._signalInterval);
      if (this.props.config?.continuous) {
  ...
  private _pointerDown(e: PointerEvent) {
    ...
    window.addEventListener(InteractionEvents.PointerUp, (event) =>
  ...
  private _pointerUp(event: PointerEvent) {
    ...
    window.removeEventListener(InteractionEvents.PointerUp, (event) =>
      this._pointerUp(event)
    );
    window.removeEventListener(InteractionEvents.PointerMove, (event) =>
      this._pointerMove(event)
